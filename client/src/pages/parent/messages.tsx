...
export default function ParentMessages() {
  ...
  // For each child, get the assigned driver
  ...
  const isLoading = isLoadingChildren || isLoadingContacts;
    ...
    <AppLayout>
      <div className="px-4 py-6 pb-20">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Chat with your child's driver or school administrators</p>
        </div>
              ...
              <CardContent className="p-0">
                <Tabs defaultValue="drivers" className="w-full">
                  ...
                  <TabsContent value="drivers" className="m-0">
                    {isLoading ? (
                    ...
                    ) : filteredContacts.filter(c => c.role === 'driver').length === 0 ? (
                      ...
                      <div className="divide-y">
                        {filteredContacts
                          .filter((contact: any) => contact.role === 'driver')
                          .map((contact: any) => (
                            <div 
                              key={contact.id}
                            ...
                            >
                              ...
                              <div>
                                ...
                                <div className="text-sm text-muted-foreground">Driver - Bus #{contact.busNumber}</div>
                              </div>
                            </div>
                          ))}
                      </div>
                        ...
                        {filteredContacts
                          ...
                          .map((contact: any) => (
                            ...
                            >
                              ...
                              <div>
                                <div className="font-medium">{contact.firstName} {contact.lastName}</div>
                                <div className="text-sm text-muted-foreground">Transport Admin</div>
                              </div>
                            </div>
                          ))}
                      </div>
              ...
              <Card className="flex flex-col h-full">
                <CardContent className="flex-1 flex flex-col items-center justify-center text-center p-6">
                  ...
                  <p className="text-gray-600 max-w-md">
                    Choose a driver or administrator from the list to start a conversation
                  </p>
                </CardContent>
              </Card>
            )}
